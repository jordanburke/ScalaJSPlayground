...
/**
 * Created by Jordan on 7/4/2015 for ScalaJSPlayground
 */
object THREE {

  @JSName("THREE.Vector3")
  class Vector3(var x: js.JSNumberOps, var y: js.JSNumberOps, var z: js.JSNumberOps) extends js.Object
  ...
  class PerspectiveCamera(a: js.JSNumberOps, b: js.JSNumberOps, c: js.JSNumberOps, d: js.JSNumberOps) extends Camera {
